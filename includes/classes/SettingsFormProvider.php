...
class SettingsFormProvider {
    ...
    public function createUserDetailsForm($firstName, $lastName, $email) {
        ...
        $saveButtonInput = $this->createSaveUserDetailsButtonInput();
    ...
    public function createPasswordForm() {
        ...
        $newPassword2Input = $this->createPasswordInput("newPassword2", "Confirm wew password");
        
        $saveButtonInput = $this->createSavePasswordButton();
    ...
    private function createSaveUserDetailsButtonInput() {
