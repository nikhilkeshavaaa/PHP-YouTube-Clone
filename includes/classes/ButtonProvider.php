...
class ButtonProvider {
    ...
    public static function createSubscriberButton($con, $userToObj, $userLoggedInObj){ 
        ...
        $isSubscribededTo = $userLoggedInObj->isSubscribedTo($userTo);
        $buttonText = $isSubscribededTo ? "SUBSCRIBED" : "SUBSCRIBE";
        $buttonText .= " " . $userToObj->getSubscriberCount(); 
        
        $buttonClass = $isSubscribededTo ? "unsubscribe button" : "subscribe button";
