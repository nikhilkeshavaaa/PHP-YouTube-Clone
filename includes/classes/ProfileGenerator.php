...
class ProfileGenerator {
    ...
    public function createContentSection() {
        ...
        if (sizeof($videos) > 0){ 
            ...
            $videoGrind = new VideoGrid($this->con, $this->userLoggedInObj); 
            $videoGrindHtml = $videoGrind->create($videos, null, false); 
            
        }else { 
            
            $videoGrindHtml = "<span>This user has no videos</span>"; 
        }
